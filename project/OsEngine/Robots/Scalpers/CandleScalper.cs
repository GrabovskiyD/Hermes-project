...
{
    public class CandleScalper : BotPanel
    {
        public CandleScalper(string name, StartProgram startProgram)
        ...
        {
            return "CandleScalper";
        }

        public override void ShowIndividualSettingsDialog()
        {
            CandleScalperUi ui = new CandleScalperUi(this);
            ui.ShowDialog();
        }
